...
// This file is only used when USE_MOCK_DATA=true or when the API is unreachable.
// In production builds, VITE_USE_MOCK_DATA defaults to false — real data
