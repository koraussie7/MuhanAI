	...
	return (
		<section className="panel">
				...
				{CAST_RESULTS.map((r, i) => (
					...
					>
						<div className="agent-header">
							...
							<span
								className={`agent-confidence ${r.confidence > 0.9 ? "high" : r.confidence > 0.7 ? "medium" : "low"}`}
							>
			...
			<div style={{ marginTop: 16, display: "flex", gap: 8 }}>
				...
				<button className="btn-secondary small" onClick={() => setStep(0)}>
					Reset
				</button>
			</div>
		</section>
