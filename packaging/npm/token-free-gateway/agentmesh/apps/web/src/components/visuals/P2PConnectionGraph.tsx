...
import { Network, Activity, Zap, Shield, Wifi, RefreshCw, Cpu, Bot, Users, Globe, ChevronRight } from 'lucide-react';
...
const INITIAL_EDGES: P2PEdge[] = [
  { from: 'gateway-core', to: 'model-claude', protocol: 'direct', bandwidth: '840 Mbps', active: true },
  { from: 'gateway-core', to: 'model-deepseek', protocol: 'libp2p', bandwidth: '620 Mbps', active: true },
  { from: 'gateway-core', to: 'model-gemini', protocol: 'direct', bandwidth: '750 Mbps', active: true },
  { from: 'gateway-core', to: 'peer-edge-1', protocol: 'webrtc', bandwidth: '120 Mbps', active: true },
  { from: 'gateway-core', to: 'peer-edge-4', protocol: 'webrtc', bandwidth: '480 Mbps', active: true },
  { from: 'gateway-core', to: 'human-validator', protocol: 'webrtc', bandwidth: '45 Mbps', active: true },
  // Cross peer-to-peer links (Mesh)
  { from: 'model-claude', to: 'model-deepseek', protocol: 'libp2p', bandwidth: '400 Mbps', active: true },
  { from: 'model-claude', to: 'model-gemini', protocol: 'direct', bandwidth: '500 Mbps', active: true },
  { from: 'peer-edge-1', to: 'peer-edge-2', protocol: 'webrtc', bandwidth: '80 Mbps', active: true },
  { from: 'peer-edge-2', to: 'human-validator', protocol: 'webrtc', bandwidth: '40 Mbps', active: true },
  { from: 'peer-edge-3', to: 'human-validator', protocol: 'libp2p', bandwidth: '60 Mbps', active: true },
  { from: 'peer-edge-4', to: 'peer-edge-3', protocol: 'libp2p', bandwidth: '110 Mbps', active: true },
];
      ...
      <div className="p2p-graph-body">
        ...
        <div className="p2p-canvas-wrapper">
          ...
          >
            ...
            {/* Orbit Guides */}
            <circle cx="400" cy="220" r="140" fill="none" stroke="rgba(255, 255, 255, 0.04)" strokeDasharray="3 6" />
            <circle cx="400" cy="220" r="200" fill="none" stroke="rgba(255, 255, 255, 0.03)" strokeDasharray="4 8" />
