...
export const WorldMeshPanel: React.FC = () => {
  ...
  return (
    <div className="cline-chat-container">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p className="dashboard-hero-desc">
              3D 세계 지구본 + 실시간 이벤트 + Pythia Python 분석. 키 없이,
              비용 없이 muhanai.com Token-Free Gateway.
            </p>
          </div>
          <button
            type="button"
            onClick={() => { void load(); void loadConcepts(); }}
      ...
      {worldError && (
        <p style={{ color: "#f59e0b", fontSize: 12, marginTop: 8 }}>{worldError}</p>
      )}
    </div>
  );
};
