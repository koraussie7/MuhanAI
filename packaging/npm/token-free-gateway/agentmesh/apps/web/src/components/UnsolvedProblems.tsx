import { ArrowRight, BookOpen, Bot, CheckCircle2, Flame, Globe, Users } from "lucide-react";
	...
	return (
		<section className="unsolved-problems-section">
			...
			<div className="section-head-boxed">
				...
				<h2 className="section-boxed-title">UNSOLVED PROBLEMS</h2>
				<p className="section-boxed-desc">
					단일 모델로는 풀 수 없거나 인간 전문가의 피드백이 반드시 필요한 P2P 네트워크 미해결
					과제입니다.
				</p>
			</div>
							...
							<div className="problem-stats-grid">
								...
								<div className="stat-box highlight">
									...
									<span
										...
										style={{
											color: problem.consensus >= 60 ? "var(--cline-green)" : "var(--cline-amber)",
										}}
									>
										{problem.consensus}%
									</span>
							...
							<div className="problem-card-footer">
								<div className="problem-tags-row">
									{problem.tags.map((tag) => (
										<span key={tag} className="problem-tag-chip">
											#{tag}
										</span>
									))}
								</div>
