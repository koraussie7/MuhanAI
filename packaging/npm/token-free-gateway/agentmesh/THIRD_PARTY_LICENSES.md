...
- **License**: MIT
- **Files**: `packages/peer-mesh/src/identity.ts`, `packages/federation/src/crypto/ecdsa-p256.ts`
...
- **Source**: [folklore](https://github.com/usefolklore/folklore) — `packages/federation/src/protocols/folklore.ts`
- **License**: MIT
- **Files**: `packages/federation/src/protocols/folklore.ts` (SignedRecord, QueryMessage)
...
- **Files**: `packages/peer-mesh/src/identity.ts` (IDENTITY_FORMAT_CURRENT = "ed25519-raw-v1")
