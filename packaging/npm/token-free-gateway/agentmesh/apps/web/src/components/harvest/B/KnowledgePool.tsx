...
const KNOWLEDGE_ITEMS: KnowledgeItem[] = [
  { title: "베트남 비자 규정", kind: "gov", confidence: 92, provenance: "gov.vn · 2025-03" },
  { title: "USDT P2P 거래 가이드", kind: "community", confidence: 74, provenance: "community · 2025-06" },
  { title: "다낭 장기 거주 팁", kind: "local", confidence: 88, provenance: "local-guide · 2025-01" },
];
