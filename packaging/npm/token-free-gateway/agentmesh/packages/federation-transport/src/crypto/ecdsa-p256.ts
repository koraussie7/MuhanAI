 ...
 *
 * External callers should import from `@agentmesh/federation-transport`
...
export async function verify(data: string, signatureHex: string, publicKeyHex: string): Promise<boolean> {
  try {
