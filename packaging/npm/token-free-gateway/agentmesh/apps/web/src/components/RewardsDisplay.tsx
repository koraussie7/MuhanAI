	...
	recentEvents = [
		{
			...
			type: "answer",
			amount: 120,
			description: "Answered: Vietnam business registration",
			timestamp: "2 min ago",
		},
		{
			id: "2",
			type: "verify",
			amount: 80,
			description: "Verified: FPT Internet 500Mbps claim",
		...
		},
		{
			...
			type: "teach",
			amount: 250,
			description: "Taught: Myanmar P2P USDT trading",
		...
		},
		{
			...
			type: "compute",
			amount: 40,
			description: "Shared GPU: 2 hours",
		...
		},
		{
			...
			type: "knowledge",
			amount: 200,
			description: "Added knowledge: Danang living costs",
