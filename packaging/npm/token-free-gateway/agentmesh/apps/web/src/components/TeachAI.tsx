			...
			<section className="teach-ai-section success-state">
				...
				<div className="knowledge-candidate">
					...
					<div className="candidate-actions">
						<button type="button" className="btn-primary submit-knowledge-btn">
							Submit for Verification
						</button>
						<button
							type="button"
							className="btn-secondary teach-more-btn"
		...
		<section className="teach-ai-section">
			...
			<form onSubmit={handleSubmit} className="teach-form">
				<textarea
					...
					placeholder={
						'예: "나는 미얀마에서 10년간 사업을 했는데... 현지에서 실제로 겪은 문제들은..."'
					}
					value={knowledge}
				...
				<button
					type="submit"
					className="btn-primary create-knowledge-btn"
