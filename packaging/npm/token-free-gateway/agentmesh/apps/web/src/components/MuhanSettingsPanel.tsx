...
import { Monitor, KeyRound, Trash2, RefreshCw, ShieldCheck } from "lucide-react";
...
function stubAdapter(): MuhanSettings {
  return {
    ...
    async listVault() {
      return [
        { service: "openai", hasSecret: true, updatedAt: Date.now() - 86_400_000 },
        { service: "anthropic", hasSecret: true, updatedAt: Date.now() - 2 * 86_400_000 },
      ];
    },
