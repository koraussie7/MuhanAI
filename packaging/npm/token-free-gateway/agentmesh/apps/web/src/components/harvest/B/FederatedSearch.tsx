...
const DEMO_RESULTS: SearchResult[] = [
  { title: "베트남 비자 런 규정 2025", snippet: "최근 변경된 비자 규정에 대한 요약...", verified: true, source: "gov.vn", confidence: 92 },
  { title: "USDT P2P 거래 안전 가이드", snippet: "미얀마 현지 P2P 거래 시 주의사항...", verified: false, source: "community", confidence: 74 },
  { title: "다낭 장기 거주 팁", snippet: "다낭에서 장기 거주를 위한 정보...", verified: true, source: "local-guide", confidence: 88 },
];
      ...
      <div className="trend-list">
        {DEMO_RESULTS.map((r, i) => (
          <div key={i} className="trend-row">
            ...
            <span className={`agent-badge ${r.verified ? "Agent" : "Human"}`}>{r.verified ? "Verified" : "Unverified"}</span>
          </div>
        ))}
      </div>
    </section>
