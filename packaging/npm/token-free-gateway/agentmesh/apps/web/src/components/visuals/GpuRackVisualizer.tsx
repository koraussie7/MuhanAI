...
const INITIAL_BLADES: GpuBlade[] = [
  { id: "blade-01", slot: 1, model: "NVIDIA A100 SXM4 80GB", vramUsed: 74, vramTotal: 80, utilization: 92, temp: 68, fanSpeed: 78, activeJob: "DeepSeek-R1-32B Batch #982", status: "active" },
  { id: "blade-02", slot: 2, model: "NVIDIA H100 NVL 94GB", vramUsed: 89, vramTotal: 94, utilization: 98, temp: 74, fanSpeed: 88, activeJob: "Llama-3.3-70B Q4 Sharded", status: "active" },
  { id: "blade-03", slot: 3, model: "Apple Silicon M3 Max 128GB", vramUsed: 42, vramTotal: 128, utilization: 48, temp: 52, fanSpeed: 45, activeJob: "WebSession Relay & Embedding", status: "active" },
  { id: "blade-04", slot: 4, model: "GeForce RTX 4090 24GB", vramUsed: 21, vramTotal: 24, utilization: 84, temp: 64, fanSpeed: 72, activeJob: "InfoMesh Vector Indexing", status: "active" },
];
    ...
    <div className="gpu-rack-container">
      <div className="gpu-rack-header">
        ...
        <div className="gpu-rack-stats">
          <span>총 VRAM: <strong>226 / 326 GB</strong></span>
          <span>연산 클럭: <strong>3.2 GHz</strong></span>
        </div>
      </div>
              ...
              <div className="blade-faceplate">
                ...
                <div className="blade-meter-col">
                  <div className="blade-meter-labels">
                    <span>VRAM {b.vramUsed}G / {b.vramTotal}G</span>
                    <strong style={{ color: vramPct > 90 ? "#ffb86b" : "#e6ff87" }}>{vramPct}%</strong>
                  </div>
                  <div className="blade-bar-track">
                    <div
                      ...
                      style={{
                        width: `${vramPct}%`,
                        background: vramPct > 90 ? "linear-gradient(90deg, #ffb86b, #ff5c5c)" : "linear-gradient(90deg, #38bdf8, #e6ff87)",
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="blade-load-col">
                  ...
                  <div className="blade-bar-track">
                    <div
                      className="blade-bar-fill load"
                      style={{ width: `${b.utilization}%` }}
                    />
                  </div>
                </div>

                <div className="blade-fan-badge">
                  FAN: {b.fanSpeed}%
                </div>
              </div>
            </div>
