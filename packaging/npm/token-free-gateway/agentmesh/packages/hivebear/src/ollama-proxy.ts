...
type HttpProxyClient = typeof globalThis extends { fetch: infer F } ? F : typeof globalThis.fetch;
...
const STRIPPED_UPSTREAM_HEADERS = new Set(["authorization", "cookie", "x-api-key"]);
