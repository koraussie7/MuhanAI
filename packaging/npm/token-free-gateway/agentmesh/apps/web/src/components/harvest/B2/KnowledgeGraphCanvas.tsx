  ...
  return (
    <section className="panel">
      ...
      <svg
        ...
        className="w-full"
        style={{ height: 420, border: "1px solid #1f1f1f", borderRadius: 12, background: "#0a0a0a" }}
      >
        {EDGES.map((edge, i) => {
          ...
          return (
            <g key={`edge-${i}`}>
              ...
              {edge.label && (
                <text x={mx} y={my} textAnchor="middle" dy="-4" fill="#71717a" fontSize="10" fontFamily="monospace">
                  {edge.label}
                </text>
              )}
            </g>
