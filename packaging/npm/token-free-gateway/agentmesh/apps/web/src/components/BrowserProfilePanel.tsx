...
import { Globe, Eye, Trash2, RefreshCw, Fingerprint, MapPin, PowerOff } from "lucide-react";
  ...
  return (
    <section className="browser-profile-panel" style={{ display: "grid", gap: 16, padding: 16 }}>
      ...
      <p style={{ color: "#8f9188", fontSize: 13, margin: 0 }}>
        Profiles pin a <strong>seed</strong> (browser identity). Timezone, locale and
        geography come from the <strong>proxy exit</strong>, not the profile — change
        the proxy to change the apparent location.
      </p>
