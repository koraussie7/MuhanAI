import { KnowledgeNode, UserActivity, SourceType } from "../../shared/types";
import { CategoryContext } from "../../shared/types";
...
export class KnowledgeExtractor {
  async extract(params: {
    ...
    return {
      title,
      content,
      categoryId: category.subdomain
        ? `${category.domain}.${category.subdomain}`
        : category.domain,
      sourceType,
      confidence: 0.7,
      metadata: {
...
export function toKnowledgeNode(
  ownerId: string,
