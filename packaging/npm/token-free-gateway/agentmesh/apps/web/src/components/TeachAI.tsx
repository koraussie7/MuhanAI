      ...
      <section className="teach-ai-section success-state">
        ...
        <div className="knowledge-candidate">
          ...
          <div className="candidate-actions">
            <button type="button" className="btn-primary submit-knowledge-btn">Submit for Verification</button>
            <button type="button" className="btn-secondary teach-more-btn" onClick={() => setSubmitted(false)}>
              더 가르치기
            </button>
          </div>
        </div>
