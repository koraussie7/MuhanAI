...
export interface I18nContent {
	...
	cosmicHud: {
		...
		connectPeerTitle: string;
		connectPeer: string;
		devicePeerManage: string;
		devicePeerConnect: string;
		userFallback: string;
		connectedSuffix: string;
		connectPrefix: string;
		connectMyDevice: string;
		physicsTitle: string;
		fullscreenTitle: string;
		graphForces: string;
		repelForce: string;
		linkDistance: string;
		centerGravity: string;
	...
	promptBar: {
		...
		byokEnabledTitle: string;
		byokSetupTitle: string;
		byokSettingsOpenAria: string;
		byokSettingsAria: string;
		byokActive: string;
		panelCloseTitle: string;
		byokPanelCloseAria: string;
		keyHideTitle: string;
		keyShowTitle: string;
		keyHideAria: string;
		keyShowAria: string;
		keySaveRefresh: string;
		keySaveActivate: string;
		keyDeleteTitle: string;
		keyDelete: string;
...
export const TRANSLATIONS: Record<SupportedLanguage, I18nContent> = {
	ko: {
		...
		cosmicHud: {
			...
			userGuideTitle: "MuhanAI 사용설명서 열기",
			connectPeerTitle: "새로운 P2P 피어 노드 이름을 지정하고 연결합니다",
			connectPeer: "피어 연결",
			devicePeerManage: "내 디바이스 피어 이름 변경 또는 관리",
			devicePeerConnect: "내 디바이스 피어 이름을 지정하고 P2P 메쉬에 마운트합니다",
			userFallback: "사용자",
			connectedSuffix: "(연결됨)",
			connectPrefix: "연결",
			connectMyDevice: "내 디바이스 연결",
			physicsTitle: "그래프 물리 파라미터",
			fullscreenTitle: "전체화면 전환",
			graphForces: "옵시디언 그래프 힘",
			repelForce: "반발력",
			linkDistance: "연결 거리",
			centerGravity: "중심 중력",
			visibleFilters: "표시 필터",
			eventFeed: "P2P 메쉬 이벤트 피드 & WEBRTC CRDT 로그",
			peersLabel: "피어:",
			notesLabel: "노트:",
			synapsesLabel: "시냅스:",
			latencyLabel: "지연:",
			subtitle: "옵시디언 그래프 토폴로지 & P2P 실루엣",
		},
		promptBar: {
			computerUseTitle: "Computer Use (e2b Desktop) — BYOK 비전 모델로 데스크톱 자동 조종",
			byokEnabledTitle: "BYOK 활성화됨 — 클릭하여 설정 변경",
			byokSetupTitle: "BYOK 설정 — 자신의 API 키 사용",
			byokSettingsOpenAria: "BYOK 설정 열기",
			byokSettingsAria: "BYOK 설정",
			byokActive: "활성",
			panelCloseTitle: "패널 닫기",
			byokPanelCloseAria: "BYOK 패널 닫기",
			keyHideTitle: "키 숨기기",
			keyShowTitle: "키 표시",
			keyHideAria: "API 키 숨기기",
			keyShowAria: "API 키 표시",
			keySaveRefresh: "키 저장 / 갱신",
			keySaveActivate: "키 저장하고 활성화",
			keyDeleteTitle: "localStorage에서 키 삭제",
			keyDelete: "키 삭제 (Forget)",
			currentlyUsing: "현재 사용 중:",
			publishTitle: "Canvas에 Obsidian 노드로 영구 발행",
			published: "발행 완료",
			copyAnswerTitle: "답변 복사",
	...
	en: {
		...
		cosmicHud: {
			...
			userGuideTitle: "Open MuhanAI User Guide",
			connectPeerTitle: "Specify and connect a new P2P peer node",
			connectPeer: "Connect Peer",
			devicePeerManage: "Change or manage your device peer name",
			devicePeerConnect: "Set your device peer name and mount to the P2P mesh",
			userFallback: "User",
			connectedSuffix: "(connected)",
			connectPrefix: "Connect",
			connectMyDevice: "Connect My Device",
			physicsTitle: "Graph Physics Parameters",
			fullscreenTitle: "Toggle Fullscreen",
			graphForces: "Obsidian Graph Forces",
			repelForce: "Repel Force",
			linkDistance: "Link Distance",
			centerGravity: "Center Gravity",
			visibleFilters: "VISIBLE FILTERS",
			eventFeed: "P2P MESH EVENT FEED & WEBRTC CRDT LOG",
			peersLabel: "Peers:",
			notesLabel: "Notes:",
			synapsesLabel: "Synapses:",
			latencyLabel: "Latency:",
			subtitle: "Obsidian Graph Topology & P2P Silhouette",
		},
		promptBar: {
			computerUseTitle: "Computer Use (e2b Desktop) — desktop control via BYOK vision model",
			byokEnabledTitle: "BYOK enabled — click to change settings",
			byokSetupTitle: "BYOK settings — use your own API key",
			byokSettingsOpenAria: "Open BYOK settings",
			byokSettingsAria: "BYOK settings",
			byokActive: "Active",
			panelCloseTitle: "Close panel",
			byokPanelCloseAria: "Close BYOK panel",
			keyHideTitle: "Hide key",
			keyShowTitle: "Show key",
			keyHideAria: "Hide API key",
			keyShowAria: "Show API key",
			keySaveRefresh: "Save / refresh key",
			keySaveActivate: "Save key & activate",
			keyDeleteTitle: "Delete key from localStorage",
			keyDelete: "Delete key (Forget)",
			currentlyUsing: "Currently using:",
			publishTitle: "Permanently publish to Canvas as Obsidian node",
			published: "Published",
	...
	ja: {
		...
		cosmicHud: {
			developerConsole: "開発者コンソール",
			userGuideTitle: "MuhanAIユーザーガイドを開く",
			connectPeerTitle: "新しいP2Pピアノードを指定して接続",
			connectPeer: "ピアを接続",
			devicePeerManage: "デバイスピア名を変更または管理",
			devicePeerConnect: "デバイスピア名を設定しP2Pメッシュにマウント",
			userFallback: "ユーザー",
			connectedSuffix: "(接続済み)",
			connectPrefix: "接続",
			connectMyDevice: "マイデバイスを接続",
			physicsTitle: "グラフ物理パラメータ",
			fullscreenTitle: "全画面切替",
			graphForces: "Obsidianグラフの力",
			repelForce: "反発力",
			linkDistance: "リンク距離",
			centerGravity: "中心重力",
			visibleFilters: "表示フィルター",
			eventFeed: "P2Pメッシュイベントフィード & WEBRTC CRDTログ",
			peersLabel: "ピア:",
			notesLabel: "ノート:",
			synapsesLabel: "シナプス:",
			latencyLabel: "遅延:",
			subtitle: "Obsidianグラフトポロジー & P2Pシルエット",
		},
		promptBar: {
			computerUseTitle: "Computer Use (e2b Desktop) — BYOKビジョンモデルでデスクトップ自動操作",
			byokEnabledTitle: "BYOK有効 — クリックで設定変更",
			byokSetupTitle: "BYOK設定 — 自身のAPIキーを使用",
			byokSettingsOpenAria: "BYOK設定を開く",
			byokSettingsAria: "BYOK設定",
			byokActive: "有効",
			panelCloseTitle: "パネルを閉じる",
			byokPanelCloseAria: "BYOKパネルを閉じる",
			keyHideTitle: "キーを隠す",
			keyShowTitle: "キーを表示",
			keyHideAria: "APIキーを隠す",
			keyShowAria: "APIキーを表示",
			keySaveRefresh: "キー保存 / 更新",
			keySaveActivate: "キーを保存して有効化",
			keyDeleteTitle: "localStorageからキーを削除",
			keyDelete: "キー削除 (Forget)",
			currentlyUsing: "現在使用中:",
			publishTitle: "CanvasにObsidianノードとして永続発行",
			published: "発行済み",
			copyAnswerTitle: "回答をコピー",
	...
	zh: {
		...
		cosmicHud: {
			...
			userGuideTitle: "打开 MuhanAI 使用说明",
			connectPeerTitle: "指定并连接新的 P2P 对等节点",
			connectPeer: "连接对等节点",
			devicePeerManage: "更改或管理您的设备对等名称",
			devicePeerConnect: "设置设备对等名称并挂载到 P2P 网格",
			userFallback: "用户",
			connectedSuffix: "（已连接）",
			connectPrefix: "连接",
			connectMyDevice: "连接我的设备",
			physicsTitle: "图形物理参数",
			fullscreenTitle: "切换全屏",
			graphForces: "Obsidian 图谱力",
			repelForce: "排斥力",
			linkDistance: "连接距离",
			centerGravity: "中心重力",
			visibleFilters: "可见筛选",
			eventFeed: "P2P 网格事件源 & WEBRTC CRDT 日志",
			peersLabel: "对等节点：",
			notesLabel: "笔记：",
			synapsesLabel: "突触：",
			latencyLabel: "延迟：",
			subtitle: "Obsidian 图谱拓扑 & P2P 轮廓",
		},
		promptBar: {
			computerUseTitle: "Computer Use (e2b Desktop) — 通过 BYOK 视觉模型自动操控桌面",
			byokEnabledTitle: "BYOK 已启用 — 点击更改设置",
			byokSetupTitle: "BYOK 设置 — 使用您自己的 API 密钥",
			byokSettingsOpenAria: "打开 BYOK 设置",
			byokSettingsAria: "BYOK 设置",
			byokActive: "已启用",
			panelCloseTitle: "关闭面板",
			byokPanelCloseAria: "关闭 BYOK 面板",
			keyHideTitle: "隐藏密钥",
			keyShowTitle: "显示密钥",
			keyHideAria: "隐藏 API 密钥",
			keyShowAria: "显示 API 密钥",
			keySaveRefresh: "保存 / 刷新密钥",
			keySaveActivate: "保存密钥并启用",
			keyDeleteTitle: "从 localStorage 删除密钥",
			keyDelete: "删除密钥 (Forget)",
			currentlyUsing: "当前使用:",
			publishTitle: "作为 Obsidian 节点永久发布到 Canvas",
			published: "已发布",
			copyAnswerTitle: "复制回答",
			apiKeyRequired: "请输入您的 API 密钥",
	...
	es: {
		...
		cosmicHud: {
			...
			userGuideTitle: "Abrir Guía de Usuario MuhanAI",
			connectPeerTitle: "Especifica y conecta un nuevo nodo par P2P",
			connectPeer: "Conectar Par",
			devicePeerManage: "Cambiar o gestionar el nombre de tu par dispositivo",
			devicePeerConnect: "Define el nombre de tu par dispositivo y móntalo en la malla P2P",
			userFallback: "Usuario",
			connectedSuffix: "(conectado)",
			connectPrefix: "Conectar",
			connectMyDevice: "Conectar Mi Dispositivo",
			physicsTitle: "Parámetros de Física del Grafo",
			fullscreenTitle: "Alternar Pantalla Completa",
			graphForces: "Fuerzas del Grafo Obsidian",
			repelForce: "Fuerza de Repulsión",
			linkDistance: "Distancia de Enlace",
			centerGravity: "Gravedad Central",
			visibleFilters: "FILTROS VISIBLES",
			eventFeed: "FEED DE EVENTOS DE MALLA P2P & REGISTRO CRDT WEBRTC",
			peersLabel: "Pares:",
			notesLabel: "Notas:",
			synapsesLabel: "Sinapsis:",
		...
		promptBar: {
			...
			byokSettingsAria: "Ajustes BYOK",
			byokActive: "Activo",
			panelCloseTitle: "Cerrar panel",
			byokPanelCloseAria: "Cerrar panel BYOK",
			keyHideTitle: "Ocultar clave",
			keyShowTitle: "Mostrar clave",
			keyHideAria: "Ocultar clave API",
			keyShowAria: "Mostrar clave API",
			keySaveRefresh: "Guardar / renovar clave",
			keySaveActivate: "Guardar clave y activar",
			keyDeleteTitle: "Eliminar clave de localStorage",
			keyDelete: "Eliminar clave (Forget)",
			currentlyUsing: "Usando ahora:",
			publishTitle: "Publicar permanentemente en Canvas como nodo Obsidian",
			published: "Publicado",
			copyAnswerTitle: "Copiar respuesta",
			apiKeyRequired: "Introduce tu clave API",
	...
	de: {
		...
		cosmicHud: {
			...
			userGuideTitle: "MuhanAI-Benutzerhandbuch öffnen",
			connectPeerTitle: "Neuen P2P-Peer-Knoten festlegen und verbinden",
			connectPeer: "Peer Verbinden",
			devicePeerManage: "Geräte-Peer-Namen ändern oder verwalten",
			devicePeerConnect: "Geräte-Peer-Namen festlegen und ins P2P-Mesh einhängen",
			userFallback: "Benutzer",
			connectedSuffix: "(verbunden)",
			connectPrefix: "Verbinden",
			connectMyDevice: "Mein Gerät Verbinden",
			physicsTitle: "Graphen-Physikparameter",
			fullscreenTitle: "Vollbild Umschalten",
			graphForces: "Obsidian-Graphenkräfte",
			repelForce: "Abstoßungskraft",
			linkDistance: "Verbindungsabstand",
			centerGravity: "Zentrierschwerkraft",
			visibleFilters: "SICHTBARE FILTER",
			eventFeed: "P2P-MESH-EVENT-FEED & WEBRTC-CRDT-LOG",
			peersLabel: "Peers:",
			notesLabel: "Notizen:",
			synapsesLabel: "Synapsen:",
			latencyLabel: "Latenz:",
			subtitle: "Obsidian-Graphentopologie & P2P-Silhouette",
		},
		promptBar: {
			computerUseTitle: "Computer Use (e2b Desktop) — Desktopsteuerung per BYOK-Visionsmodell",
			byokEnabledTitle: "BYOK aktiviert — zum Ändern klicken",
			byokSetupTitle: "BYOK-Einstellungen — eigene API-Schlüssel verwenden",
			byokSettingsOpenAria: "BYOK-Einstellungen öffnen",
			byokSettingsAria: "BYOK-Einstellungen",
			byokActive: "Aktiv",
			panelCloseTitle: "Panel schließen",
			byokPanelCloseAria: "BYOK-Panel schließen",
			keyHideTitle: "Schlüssel verbergen",
			keyShowTitle: "Schlüssel anzeigen",
			keyHideAria: "API-Schlüssel verbergen",
			keyShowAria: "API-Schlüssel anzeigen",
			keySaveRefresh: "Schlüssel speichern / erneuern",
			keySaveActivate: "Schlüssel speichern & aktivieren",
			keyDeleteTitle: "Schlüssel aus localStorage löschen",
			keyDelete: "Schlüssel löschen (Forget)",
			currentlyUsing: "Aktiv genutzt:",
			publishTitle: "Dauerhaft als Obsidian-Knoten auf Canvas veröffentlichen",
			published: "Veröffentlicht",
			copyAnswerTitle: "Antwort kopieren",
	...
	fr: {
		...
		cosmicHud: {
			...
			userGuideTitle: "Ouvrir le Guide de l'Utilisateur MuhanAI",
			connectPeerTitle: "Spécifiez et connectez un nouveau nœud pair P2P",
			connectPeer: "Connecter un Pair",
			devicePeerManage: "Modifier ou gérer le nom de votre pair appareil",
			devicePeerConnect: "Définissez le nom de votre pair appareil et montez-le sur le mesh P2P",
			userFallback: "Utilisateur",
			connectedSuffix: "(connecté)",
			connectPrefix: "Connecter",
			connectMyDevice: "Connecter Mon Appareil",
			physicsTitle: "Paramètres Physiques du Graphe",
			fullscreenTitle: "Basculer Plein Écran",
			graphForces: "Forces du Graphe Obsidian",
			repelForce: "Force de Répulsion",
			linkDistance: "Distance de Lien",
			centerGravity: "Gravité Centrale",
			visibleFilters: "FILTRES VISIBLES",
			eventFeed: "FEED D’ÉVÉNEMENTS MESH P2P & JOURNAL CRDT WEBRTC",
			peersLabel: "Pairs :",
			notesLabel: "Notes :",
			synapsesLabel: "Synapses :",
			latencyLabel: "Latence :",
			subtitle: "Topologie de Graphe Obsidian & Silhouette P2P",
		},
		promptBar: {
			computerUseTitle: "Computer Use (e2b Desktop) — contrôle du bureau via modèle de vision BYOK",
			byokEnabledTitle: "BYOK activé — cliquez pour modifier les réglages",
			byokSetupTitle: "Réglages BYOK — utilisez votre propre clé API",
			byokSettingsOpenAria: "Ouvrir les réglages BYOK",
			byokSettingsAria: "Réglages BYOK",
			byokActive: "Actif",
			panelCloseTitle: "Fermer le panneau",
			byokPanelCloseAria: "Fermer le panneau BYOK",
			keyHideTitle: "Masquer la clé",
			keyShowTitle: "Afficher la clé",
			keyHideAria: "Masquer la clé API",
			keyShowAria: "Afficher la clé API",
			keySaveRefresh: "Enregistrer / renouveler la clé",
			keySaveActivate: "Enregistrer la clé et activer",
			keyDeleteTitle: "Supprimer la clé de localStorage",
			keyDelete: "Supprimer la clé (Forget)",
			currentlyUsing: "Actuellement utilisé :",
			publishTitle: "Publier définitivement sur Canvas en tant que nœud Obsidian",
			published: "Publié",
			copyAnswerTitle: "Copier la réponse",
	...
	pt: {
		...
		cosmicHud: {
			...
			userGuideTitle: "Abrir Guia do Usuário MuhanAI",
			connectPeerTitle: "Especifique e conecte um novo nó par P2P",
			connectPeer: "Conectar Par",
			devicePeerManage: "Alterar ou gerenciar o nome do seu par dispositivo",
			devicePeerConnect: "Defina o nome do seu par dispositivo e monte na malha P2P",
			userFallback: "Usuário",
			connectedSuffix: "(conectado)",
			connectPrefix: "Conectar",
			connectMyDevice: "Conectar Meu Dispositivo",
			physicsTitle: "Parâmetros de Física do Grafo",
			fullscreenTitle: "Alternar Tela Cheia",
			graphForces: "Forças do Grafo Obsidian",
			repelForce: "Força de Repulsão",
			linkDistance: "Distância do Link",
			centerGravity: "Gravidade Central",
			visibleFilters: "FILTROS VISÍVEIS",
			eventFeed: "FEED DE EVENTOS DA MALHA P2P & LOG CRDT WEBRTC",
			peersLabel: "Pares:",
			notesLabel: "Notas:",
			synapsesLabel: "Sinapses:",
		...
		promptBar: {
			...
			byokSettingsAria: "Configurações BYOK",
			byokActive: "Ativo",
			panelCloseTitle: "Fechar painel",
			byokPanelCloseAria: "Fechar painel BYOK",
			keyHideTitle: "Ocultar chave",
			keyShowTitle: "Mostrar chave",
			keyHideAria: "Ocultar chave de API",
			keyShowAria: "Mostrar chave de API",
			keySaveRefresh: "Salvar / renovar chave",
			keySaveActivate: "Salvar chave e ativar",
			keyDeleteTitle: "Excluir chave do localStorage",
			keyDelete: "Excluir chave (Forget)",
			currentlyUsing: "Usando agora:",
			publishTitle: "Publicar permanentemente no Canvas como nó Obsidian",
			published: "Publicado",
			copyAnswerTitle: "Copiar resposta",
			apiKeyRequired: "Insira sua chave de API",
			rateLimitedHint: "⚠ Rate-Limited · BYOK recomendado",
