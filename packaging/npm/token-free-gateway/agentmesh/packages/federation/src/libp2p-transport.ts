/**
 * Real libp2p transport — delegates node construction to @agentmesh/peer-mesh.
 *
 * This file owns ONLY the Transport interface implementation. Node
 * construction, identity, pubsub, and peer catalog live in
 * @agentmesh/peer-mesh (see docs/adr/0001-m1-pulse-mesh.md).
 */

import type { PulseMessage, PulseSource } from "@agentmesh/peer-mesh";
import {
