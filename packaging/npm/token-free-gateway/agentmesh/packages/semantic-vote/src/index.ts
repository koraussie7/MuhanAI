...
const TAG_RULES: Array<{
	...
	{
		tag: "medical",
		patterns: [/의학|의료|피부암|암|질병|약|병원|건강|medical|disease|cancer|skin/i],
		weight: 1.0,
	},
	{
		tag: "skin_cancer",
		patterns: [/피부암|melanoma|skin cancer|피부.*암|선크림|자외선/i],
		weight: 1.0,
	},
	{
		tag: "finance",
		patterns: [/투자|금융|주식|펀드|세금|finance|stock|tax/i],
		weight: 0.9,
	},
	{
		tag: "legal",
		patterns: [/법률|계약|소송|변호사|legal|contract|lawsuit/i],
		weight: 0.9,
	},
	{
		tag: "research",
		patterns: [/리서치|연구|조사|논문|research|paper|study/i],
		weight: 0.8,
	},
	{
		tag: "code",
		patterns: [/코드|프로그래밍|개발|버그|디버그|code|programming|debug/i],
		weight: 0.8,
	},
	{
		tag: "verify",
		patterns: [/검증|팩트체크|사실확인|verify|fact.?check/i],
		weight: 0.7,
	},
	{
		tag: "analyze",
		patterns: [/분석|데이터|통계|분석|analyze|data|stats/i],
		weight: 0.6,
	},
];
