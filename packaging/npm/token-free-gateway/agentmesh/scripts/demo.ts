...
import { processUserActivity } from "../packages/knowledge-base/src/ingestion";
...
import type { UserActivity } from "../packages/shared/types";
...
async function main() {
	...
	const question = "다낭에서 집주인이 보증금을 안 돌려주면 법적으로 어떻게 대응해야 하나요?";
