...
function main() {
	...
	if (pkgName === null) {
		console.error(`token-free-gateway: unsupported platform ${process.platform} ${process.arch}`);
		process.exit(1);
	}
	...
	const binaryName = process.platform === "win32" ? "token-free-gateway.exe" : "token-free-gateway";
