...
/**
 * First-impression onboarding banner. Static amount — actual balance
 * is fetched separately via <CreditBalance /> for live display.
 */
export function WelcomeCreditsBanner({ amount = 1_000_000 }: Props) {
  ...
  return (
    <div
      ...
      style={{
        boxShadow:
          "0 0 24px -8px rgba(34, 211, 238, 0.35), inset 0 1px 0 rgba(255,255,255,0.04)",
      }}
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <span aria-hidden="true" className="text-fuchsia-300" style={{ fontSize: 15 }}>✨</span>
          ...
          <p className="mt-1 text-sm opacity-70">
            New members receive <strong className="text-cyan-200">{formatted} Muhan Credits</strong> to
            explore AI, Agent Mesh, MCP tools and the knowledge network — no token required.
          </p>
        </div>
        <div
