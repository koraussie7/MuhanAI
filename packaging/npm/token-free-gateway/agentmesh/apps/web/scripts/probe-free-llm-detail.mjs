...
await show("openrouter-free (no key)", "https://openrouter.ai/api/v1/chat/completions", {
	method: "POST",
	headers: {
...
await show("openrouter-free (with dummy key)", "https://openrouter.ai/api/v1/chat/completions", {
	method: "POST",
	headers: {
		"Content-Type": "application/json",
...
await show("pollinations GET (short)", "https://text.pollinations.ai/prompt/OK?model=openai-fast", {
	method: "GET",
});

await show("cloudflare-wr-ai detail", "https://api.cloudflare.com/client/v4/ai/run", {
	method: "POST",
	headers: { "Content-Type": "application/json" },
	body: JSON.stringify({
