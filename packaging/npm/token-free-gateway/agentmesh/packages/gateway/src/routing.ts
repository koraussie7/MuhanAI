/**
 * @agentmesh/gateway — session routing.
 *
 ...
 *   - Reputation (from @agentmesh/credits) is used to rank machines
...
export class SessionRouter {
  ...
  route(input: {
    ...
    const target =
      ...
      machines.reduce((best, cur) =>
        cur.reputationScore > best.reputationScore ? cur : best,
      );
...
export type { SessionRoute, SessionAck };
